...
const styles = StyleSheet.create({
  ...
  scenarioActiveBox: { backgroundColor: colors.warningLight, borderRadius: radius.lg, padding: 14, borderWidth: 1, borderColor: '#E6C87A' },
  ...
  itemBadgeWarning: { fontSize: 10, color: '#8A6D1D', backgroundColor: colors.warningLight, borderRadius: radius.pill, paddingHorizontal: 6, paddingVertical: 2 },
