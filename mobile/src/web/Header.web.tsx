...
const EXTRA_TITLES: Record<string, string> = {
  HamburgerMenu: 'Menu',
  Accounts: 'Comptes',
  FinancialPlans: 'Plans financiers',
  Charges: 'Charges / Échéances',
  ...
  EnvelopeDetail: 'Détail enveloppe',
  MedicalClaims: 'Suivi mutuelle',
  PocketDetail: 'Épargne',
  CloseMedicalClaim: 'Clôturer un dossier',
  RecurringTransferDetail: 'Transfert récurrent',
  IncomeSourceDetail: 'Revenu',
  IncomeOccurrenceDetail: 'Revenu prévu',
  CreateIncome: 'Nouveau revenu',
  CreateCharge: 'Nouvelle charge',
  CreateBudget: 'Nouveau budget',
  CreatePocket: 'Nouvelle enveloppe',
  CreateGoal: 'Nouvel objectif',
  GoalDetail: 'Objectif',
  ChildCosts: 'Coûts',
  EngagedDetail: "Détail de l'engagé",
  ConfirmDeadline: 'Confirmer la facture',
  SchoolProjection: 'Projection pluriannuelle',
  SchoolWizard: 'Assistant frais scolaires',
  TravelWizard: 'Assistant voyage',
  VehicleWizard: 'Assistant véhicule',
  HousingWizard: 'Assistant logement',
  SubscriptionsWizard: 'Assistant abonnements',
  HouseholdMembers: 'Membres du foyer',
  JoinHousehold: 'Mes foyers',
  CategoryTypes: 'Types de dépenses',
  HouseholdConfig: 'Configuration du foyer',
  ResetFinancialData: 'Réinitialiser mes données',
  RecurringTransfers: 'Transferts récurrents',
  Simulator: 'Simulateur',
  Onboarding: 'Assistant de démarrage',
  EnveloppesLegacy: 'Enveloppes (détail)',
  QuickAdd: 'Ajouter',
};
